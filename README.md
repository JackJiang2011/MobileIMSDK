...
# 十、打包下载（all in one）
:paperclip: ① 最新发布版（国外地址）：[Github最新版打包地址](https://github.com/JackJiang2011/MobileIMSDK/releases/latest)

:paperclip: ② 最新发布版（国内地址）：[码云gitee最新版打包地址](https://gitee.com/jackjiang/MobileIMSDK )（访问速度快！ :point_left:）
