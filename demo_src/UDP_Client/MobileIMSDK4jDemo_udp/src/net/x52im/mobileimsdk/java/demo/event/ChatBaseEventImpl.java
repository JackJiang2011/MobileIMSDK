 ...
 * 
 * ChatBaseEventImpl.java at 2020-8-21 14:56:28, code by Jack Jiang.
 */
...
public class ChatBaseEventImpl implements ChatBaseEvent
{
	 ...
	 * 本地用户的登陆结果回调事件通知。
	 * 
	 * @param errorCode 服务端反馈的登录结果：0 表示登陆成功，否则为服务端自定义
	...
	public void onLoginResponse(int errorCode)
	{
		if (errorCode == 0) 
		{
			...
			if(this.mainGUI != null)
			{
				...
				this.mainGUI.showIMInfo_green("IM服务器登录/连接成功,dwErrorCode="+errorCode);
			}
		}
		else 
		{
