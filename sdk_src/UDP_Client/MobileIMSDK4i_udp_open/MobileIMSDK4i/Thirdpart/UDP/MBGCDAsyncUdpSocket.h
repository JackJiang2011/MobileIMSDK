...
//  version: 7.6.3, 20190429 update by Jack Jiang, 为了防止引入项目时与开发者的工程发生冲突，已加文件名前缀“MB”
//
...
**/
- (void)udpSocket:(MBGCDAsyncUdpSocket *)sock didNotConnect:(NSError * _Nullable)error;
...
**/
- (void)udpSocket:(MBGCDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError * _Nullable)error;
...
**/
- (void)udpSocketDidClose:(MBGCDAsyncUdpSocket *)sock withError:(NSError  * _Nullable)error;
...
@interface MBGCDAsyncUdpSocket : NSObject
