...
public class ConfigEntity
{
  ...
  public static void setSenseMode(SenseMode mode)
  {
    ...
    {
      net.openmob.mobileimsdk.android.core.KeepAliveDaemon.KEEP_ALIVE_INTERVAL = keepAliveInterval;
    }
    if (networkConnectionTimeout > 0)
    {
      net.openmob.mobileimsdk.android.core.KeepAliveDaemon.NETWORK_CONNECTION_TIME_OUT = networkConnectionTimeout;
    }
  }
