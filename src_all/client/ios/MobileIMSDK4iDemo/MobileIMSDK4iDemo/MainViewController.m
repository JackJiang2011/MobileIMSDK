...
- (void) refreshMyid
{
    int myLocalId = [ClientCoreSDK sharedInstance].currentUserId;
    self.myId.text = (myLocalId == -1 ? @"连接断开" : [NSString stringWithFormat:@"%d", myLocalId]);
}
